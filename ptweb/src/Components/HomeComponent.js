        ...
        <section className="w-full home-comp page-width">
            <div className="w-3/4 relative h-full justify-center flex banner" >
                ...
                <div className="absolute w-80 h-72 p-6 banner-box">
                    <div className="p-5 flex flex-col justify-center bn-one items-center">
                        <p className="font-semibold pb-2 text-xl myname">
                            Josiah Idowu
                        </p>
                        <p className="font-light tracking-widest text-sm mytitle">
                            Frontend Developer
                        </p>
                    </div>
